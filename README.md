...
If adding personalisations beyond the minimal example above, note that the `Mail` class must first be initialized with the required parameters in the minimal example above:
